...
| Build mode | container, conda, native | NFS cold-start tax (see `mskcc-hpc` skill → `references/apptainer_vs_conda.md`) |
...
- See `mskcc-hpc` skill → `references/apptainer_vs_conda.md` for the cold-start-tax rationale.
