...
- **`scripts/pmc_fetch.py`** (stdlib only) — preferred for any paper indexed
  ...
  CLI:
  ```bash
  python "${CLAUDE_PLUGIN_ROOT}/skills/journal-club/scripts/pmc_fetch.py" PMC12918801 --out-dir <paper_dir>/
  python "${CLAUDE_PLUGIN_ROOT}/skills/journal-club/scripts/pmc_fetch.py" --doi 10.64898/2026.02.12.705658 --out-dir <paper_dir>/
  ```
