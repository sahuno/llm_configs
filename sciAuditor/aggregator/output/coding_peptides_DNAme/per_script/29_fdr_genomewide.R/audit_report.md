...
- **Analysis**: `/data1/greenbab/projects/janjigian_su2c_WGS-ONT_sam/DNAme_prod/scripts/coding_peptides_DNAme/scripts/29_fdr_genomewide.R`
- **Inferred at**: 2026-05-14T23:38:05-0400
...
- **header-preserved** (L122) — 1 read call(s) drop headers explicitly (header=FALSE / col.names=FALSE)

### WARNING (2)

- **relative-paths-only** (L29, L31, L35, L38, L40, L42) — 6 CLI defaults are absolute paths
